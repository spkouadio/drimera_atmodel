...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.result_graphicsView.setGeometry(QRect(1, 1, 555, 395))
        self.result_graphicsView.setMaximumSize(QSize(555, 395))
        icon3 = QIcon()
        ...
        self.tableView.setGeometry(QRect(1, 1, 555, 395))
